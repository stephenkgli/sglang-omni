...
class ModelCapabilities:
    ...
    - supports_sglang_full_prefill: the architecture satisfies SGLang's
      multimodal ``PrefillCudaGraphRunner`` contract with the ``full`` backend.
    """
    ...
    supports_sglang_full_prefill: bool
